...
const int CODE_PACKET_RECEIVE_ERROR = 1;
...
// transactionID_size and data_size at the top of the packet send to server
const int HEADER_SIZE = 10;					
const int PADDING_BUFF = 10;

// please put the account.txt file in the folder Debug
